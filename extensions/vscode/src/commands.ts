...
// Code Bhau fork note: original import was "packages/config-yaml/dist"
// (a file: path into the monorepo's local package). Switched to the published
// npm package name — the upstream monorepo's local package and the npm
// release share the same public API for this export.
